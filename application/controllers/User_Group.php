...
class User_Group extends Admin_Controller 
{
    ...
    public function getUserGroup()
	{
		...
		foreach($users as $r)
		{
            ...
            $sub_array[] = $r->ug_id;
            $sub_array[] = $r->ug_name;            
            $sub_array[] = '<a role="button" href="'.base_url('User_Group/manage?q='.urlencode($this->encrypt->encode($r->ug_id))).'" class="btn waves-effect waves-light btn-info btn-sm"><i class="fa fa-edit"></i> Manage</a>';                            
			$data[] = $sub_array;
		}
